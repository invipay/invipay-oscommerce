  ...
  class invipay {
    ...
    function invipay() {
		...
		if(!is_object($order) && !is_object($cart) && $this->check()){
			...
			$request = new EchoIn();
			$request->setMessage("Hello world ±żłóćł");
    ...
    function install() {
		...
		if(tep_db_num_rows($check_query) > 0){
			...
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia rozpoczętej płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_STARTED_ORDER_STATUS_ID', ".$check['orders_status_id'].", 'Ustaw status zamówienia dla rozpoczętej płatno¶ci w InviPay.com', '6', '5', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		} else {
			...
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia rozpoczętej płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_STARTED_ORDER_STATUS_ID', ".$status_id.", 'Ustaw status zamówienia dla rozpoczętej płatno¶ci w InviPay.com', '6', '5', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		}
		...
		if(tep_db_num_rows($check_query) > 0){
			$check = tep_db_fetch_array($check_query);
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia odrzuconej płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_OUT_OF_LIMIT_ORDER_STATUS_ID', ".$check['orders_status_id'].", 'Status zamówienia dla odrzuconej płatno¶ci w InviPay.com', '6', '6', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		} else {
			$next_id_query = tep_db_query("select max(orders_status_id) as orders_status_id from " . TABLE_ORDERS_STATUS . "");
            $next_id = tep_db_fetch_array($next_id_query);
            $orders_status_id = $next_id['orders_status_id'] + 1;
			...
			tep_db_perform('orders_status', $sql_data_array);
			$status_id = $orders_status_id;
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia odrzuconej płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_OUT_OF_LIMIT_ORDER_STATUS_ID', ".$status_id.", 'Status zamówienia dla odrzuconej płatno¶ci w InviPay.com', '6', '6', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		}
		...
		if(tep_db_num_rows($check_query) > 0){
			$check = tep_db_fetch_array($check_query);
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia porzuconej płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_TIMEDOUT_ORDER_STATUS_ID', ".$check['orders_status_id'].", 'Status zamówienia dla porzuconej płatno¶ci w InviPay.com', '6', '7', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		} else {
			$next_id_query = tep_db_query("select max(orders_status_id) as orders_status_id from " . TABLE_ORDERS_STATUS . "");
            $next_id = tep_db_fetch_array($next_id_query);
            $orders_status_id = $next_id['orders_status_id'] + 1;
			...
			tep_db_perform('orders_status', $sql_data_array);
			$status_id = $orders_status_id;
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia porzuconej płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_TIMEDOUT_ORDER_STATUS_ID', ".$status_id.", 'Status zamówienia dla porzuconej płatno¶ci w InviPay.com', '6', '7', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		}
		...
		if(tep_db_num_rows($check_query) > 0){
			$check = tep_db_fetch_array($check_query);
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia zaakceptowanej płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_COMPLETED_ORDER_STATUS_ID', ".$check['orders_status_id'].", 'Status zamówienia dla zaakceptowanej płatno¶ci w InviPay.com', '6', '8', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		} else {
			$next_id_query = tep_db_query("select max(orders_status_id) as orders_status_id from " . TABLE_ORDERS_STATUS . "");
            $next_id = tep_db_fetch_array($next_id_query);
            $orders_status_id = $next_id['orders_status_id'] + 1;
			...
			tep_db_perform('orders_status', $sql_data_array);
			$status_id = $orders_status_id;
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia zaakceptowanej płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_COMPLETED_ORDER_STATUS_ID', ".$status_id.", 'Status zamówienia dla zaakceptowanej płatno¶ci InviPay.com', '6', '8', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		}
		...
		if(tep_db_num_rows($check_query) > 0){
			$check = tep_db_fetch_array($check_query);
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia dla doręczonej paczki z użyciem płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_DELIVERED_ORDER_STATUS_ID', ".$check['orders_status_id'].", 'Status zamówienia dla doręczonej paczki z użyciem płatno¶ci InviPay.com', '6', '9', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		} else {
			$next_id_query = tep_db_query("select max(orders_status_id) as orders_status_id from " . TABLE_ORDERS_STATUS . "");
            $next_id = tep_db_fetch_array($next_id_query);
            $orders_status_id = $next_id['orders_status_id'] + 1;
			...
			tep_db_perform('orders_status', $sql_data_array);
			$status_id = $orders_status_id;
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia dla doręczonej paczki z użyciem płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_DELIVERED_ORDER_STATUS_ID', ".$status_id.", 'Status zamówienia dla doręczonej paczki z użyciem płatno¶ci InviPay.com', '6', '9', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		}
		...
		if(tep_db_num_rows($check_query) > 0){
			$check = tep_db_fetch_array($check_query);
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia dla doręczonej paczki i wystawionej faktury z użyciem płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_FINISHED_ORDER_STATUS_ID', ".$check['orders_status_id'].", 'Status zamówienia dla doręczonej paczki i wystawionej faktury  z użyciem płatno¶ci InviPay.com', '6', '10', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		} else {
			$next_id_query = tep_db_query("select max(orders_status_id) as orders_status_id from " . TABLE_ORDERS_STATUS . "");
            $next_id = tep_db_fetch_array($next_id_query);
            $orders_status_id = $next_id['orders_status_id'] + 1;
			...
			tep_db_perform('orders_status', $sql_data_array);
			$status_id = $orders_status_id;
			tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Status zamówienia dla doręczonej paczki i wystawionej faktury z użyciem płatno¶ci InviPay.com', 'MODULE_PAYMENT_INVIPAY_FINISHED_ORDER_STATUS_ID', ".$status_id.", 'Status zamówienia dla doręczonej paczki i wystawionej faktury z użyciem płatno¶ci InviPay.com', '6', '10', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
		}
		
		
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Pokazuj płatno¶ć InviPay.com', 'MODULE_PAYMENT_INVIPAY_STATUS', '1', 'Czy chcesz wł±czyć płatno¶ć InviPay.com?', '6', '1','invipay_pull_down_status(', 'invipay_status', now())");
	  tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Tryb demo', 'MODULE_PAYMENT_INVIPAY_DEMO', '1', 'Czy chcesz przeprowadzić testy działania płatno¶ci InviPay.com?', '6', '2', 'invipay_pull_down_demo_status(', 'invipay_demo_status', now())");
	  ...
	  tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Kolumna pola NIP', 'MODULE_PAYMENT_INVIPAY_NIP_FIELD', '', 'Wybierz zbazy danych kolumnę zawieraj±c± pole NIP klienta', '6', '11', 'invipay_pull_down_nip(', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Termin płatno¶ci', 'MODULE_PAYMENT_INVIPAY_PAYDATE', '14', 'Termin płatno¶ci faktury (zgodnie z umow± z InviPay.com) wyrażana w dniach', '6', '12', now());");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Minimalna warto¶ć koszyka', 'MODULE_PAYMENT_INVIPAY_MINCART', '200', 'Minimalna warto¶ć koszyka wyrażona w PLN dla której płatno¶ci InviPay.com będ± aktywne', '6', '13', now());");
